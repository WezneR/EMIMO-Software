...
parameter  uart_max_byte_len = 10  //默认数据深度为36，单次支持最大data_depth的接收和发送 建议最大不超过63，如果超过63，请改变下面的 send_data_bytes和receive_data_bytes
) 
(
    ...
    input  wire [uart_max_byte_len*8-1:0] send_data, //将要发送的数据  00_00_……00_XX_XX_XX   (XX 为即将发送的数据，从高位发送)
